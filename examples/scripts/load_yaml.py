...
print(f"run directory:  {simulation.environment.run_directory}")
print(f"log directory:  {simulation.environment.log_directory}")
print(f"results dir:    {simulation.environment.results_directory}")
print(f"macro file:     {simulation.environment.macro_file}")
